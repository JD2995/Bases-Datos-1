...
<html lang="en">
  ...
  <body>
      ...
      ?>
    <div class="container">
    <!-- Código para mostrar las mascota en adopción-->
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-11"><h1 style="color:#2E2E2E">Nuestras mascotas en adopción..................................</div>
    </div>
    <div class="row"></div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-3">
            <h5>¿No sabes que mascota adoptar?</h5>
        </div>
        <div class="col-sm-3"><button type="button" class="btn btn-primary">Te ayudamos</button></div>
    </div>
    <div class="row">
        <div class=""col-sm-1></di
    </div>
    <div class="row"><br></div>
    <?php
    include_once('Consulta.php');
    $consul= new Consulta();
    $mascotasArray=$consul->getEnAdopcion();
    $contadorMascotas=0;
    if(isset($_GET['cont'])){
                    ...
                    <div class=\"col-sm-8\">
                        ...
                        <ul class=\"pagination\">
                          ...
                          if($indMascota>20){
                              ...
                              print "<a href=\"http://localhost/Adopciones/Adopciones.php?cont=$anterior\" aria-label=\"Previous\">";
                          }
                            
                              print"<span aria-hidden=\"true\">&laquo;</span>
                            </a>
                          </li>
                          <li><a href=\"http://localhost/Adopciones/Adopciones.php?cont=0\">1</a></li>
                          <li><a href=\"#\">2</a></li>
                          <li><a href=\"#\">3</a></li>
                          <li><a href=\"#\">4</a></li>
                          <li><a href=\"#\">5</a></li>
                          <li>";
                            if($contadorMascotas>=20){
                                print "<a href=\"http://localhost/Adopciones/Adopciones.php?cont=$indMascota\" aria-label=\"Next\">";
                            }
                            else{
    ...
    <script type="text/javascript">
        function siguienteMascota(contMascotas){
            window.open("http://localhost/Adopciones/Adopciones.php?cont="+contMascotas,"_self");
        }
    </script>
