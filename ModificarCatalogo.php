                  ...
                  <div class=\"navbar-header\">
                    ...
                    <ul class=\"nav navbar-nav\">
                      ...
                      print "<li><a href=\"AgregarCatalogo.php\">Agregar Catalogo</a></li>
                          <li class=\"active\"><a href=\"ModificarCatalogo.php\">Modificar Catalogo</a></li>
        ...
        <div class="col-sm-8">
            <!-- Search box Start -->
             <?php print "<form role=\"form\" method=\"post\" enctype=\"multipart/form-data\""; $id=$GLOBALS['Persona_ID']; print " action=\"\"  method=\"POST\">";?>
                ...
                <label for="dropdownMenu1">Seleccione el dato que quiere modificar:</label>
                  <select id="puntaje" name="puntaje">
                ...
                <div class="form-group">
                    <div class="col-lg-5">
                        <label for="usr">Cambiar por:</label>
                      <input type="submit" value="Modificar" class = "btn btn-primary" name="submit">
